...
namespace CalRecycleLCA.Repositories
{
    ...
    {
        public static FragmentNodeResource GetFragmentNodeProcess(this IRepository<FragmentNodeProcess> repository, 
            int fragmentFlowId, int scenarioID)
        {
            ...
            if (scenarioID != 0)
            {
                var substituteNode = repository.GetRepository<ProcessSubstitution>()
                    .Query(x => x.FragmentNodeProcessID == fragmentNode.RefID
