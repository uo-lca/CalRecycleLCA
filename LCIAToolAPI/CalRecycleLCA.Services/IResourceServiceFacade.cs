...
namespace CalRecycleLCA.Services
{
    public interface IResourceServiceFacade {
        ...
        LCIAResultResource GetFragmentLCIAResultsOneMethod(int fragmentID, int lciaMethodID, int scenarioID = Scenario.MODEL_BASE_CASE_ID);
        LCIAResultResource GetRecursiveFragmentLCIAResultsOneMethod(int fragmentID, int lciaMethodID, int scenarioID = Scenario.MODEL_BASE_CASE_ID);
        ...
        IEnumerable<ProcessFlowResource> GetFragmentLCI(int fragmentId, int scenarioId = Scenario.MODEL_BASE_CASE_ID);
